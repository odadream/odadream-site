...
export const SITE_VERSION = "v4.0.0";
...
const createNode = (
  ...
  const mediaUrl =
    customMediaUrl ||
    getImg(id, imgKeywords.length ? imgKeywords : [type, "abstract"]);
  return {
    id,
...
const works = createNode(
  "works",
  "Works",
  "Работы",
  Content.works_index_md,
  "hub",
  [games, lectures, workshops, research, objects],
  true,
  undefined,
  undefined,
  ["archive", "library"],
...
export const ROOT_NODE = createNode(
  ...
  Content.index_md,
  "hub",
  [neuromandala, works, events, collaboration, world, contacts, debugNode],
  true,
  undefined,
  undefined,
  ["lotus", "galaxy"],
