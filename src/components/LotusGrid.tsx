            ...
            <div className={cn(
                ...
                <div className="flex-1 flex flex-col justify-end w-full">
                    <div className="flex items-center justify-center gap-1.5 md:gap-2 w-full">
                        ...
                        <TypeIcon strokeWidth={1} className={cn(
                            "w-2.5 h-2.5 md:w-3 md:h-3 flex-shrink-0 mix-blend-screen", 
                            cell.isCenter ? THEME.navigation.icon.active : THEME.navigation.icon.base
                        )} />
                        
                        {/* UPDATED: Uses THEME.typography.hud for bigger text */}
                        <span className={cn(
                            THEME.typography.hud, "transition-all duration-300 line-clamp-1 break-all", 
