...
This section maps our hub-research nodes by maturity and application status: from production-ready formats to active R&D hypotheses.
...
- [[schrodinger | "Schrödinger" Project]] `[status: experimental]` A performance where dramaturgy is shaped by the states of actors and audience. The viewer is integrated into the process and influences unfolding hub-events.
...
- Use [[hub-events | Events]] to see where hub-research moved into public deployment.
...
- Для публичных развёртываний и кейсов переходите в [[hub-events | События]].
