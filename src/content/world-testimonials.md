...
Verified words from organizers, institutions, and partners — about the duo and about specific works. Each quote links back to the engagement where it was given; the full set is a single ledger in `data/registry/proofs.yaml` (kind: testimonial).

<!-- registry:testimonials-all -->
> «for co-presentation at TechFriendly Weekend, part of CIPR — Digital Industry of Industrial Russia forum»
>
> — CIPR (2026)

> «for participation in the first AI festival "Cultural Code of Russia", interest in the project, and creation of your work»
>
> — Tavrida.ART (2025)
...
Подтверждённые формулировки организаторов, институций и партнёров — о дуэте и о конкретных работах. Каждая цитата связана с участием, где она прозвучала; полный корпус — единым реестром в `data/registry/proofs.yaml` (kind: testimonial).

<!-- registry:testimonials-all-ru -->
> «за совместное выступление на TechFriendly Weekend в рамках форума ЦИПР — Цифровая индустрия промышленной России»
>
> — ЦИПР (2026)
...
>
> — Студия Ashram (Натали Осман) (2024)
