...
**Program of Public Cases**

Events is the public timeline of ODA.dream where hub-research turns into shared experience.
This section combines festivals, competitions, and site-specific interventions where we test neuro-art formats with real audiences.
...
**Программа публичных кейсов**

Раздел «События» — это публичная траектория ODA.dream, где исследовательские гипотезы проверяются в реальных условиях: на фестивалях, конкурсах и городских площадках.
