...
- Current status: research and format development with public demonstration potential.

## Related Nodes

- [[research|Research]] — context of the wider R&D branch.
- [[events|Events]] — where collective formats are publicly tested.
- [[works|Works]] — neighboring implementation formats.
...
- [[research|Исследования]] — методологический контекст.
- [[events|События]] — публичные площадки тестирования формата.
- [[works|Работы]] — соседние направления применения.
