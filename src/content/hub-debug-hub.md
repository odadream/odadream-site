...
This node validates second-level hub behavior inside the hub-debug branch:

- inherited navigation from parent `hub-debug`;
...
- наследование навигации от родителя `hub-debug`;
