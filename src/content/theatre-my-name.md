...
title_en: Theatre of My Name
title_ru: Театр Имени Меня
type: content
tags:
  - theatre
  - neuromandala
...
external_site_label_en: Dzen · how it works (Part 1)
external_site_label_ru: Дзен · как это работает (ч. 1)
presented_at:
  - "[[event-korablik-2020]]"
  - "[[event-ashram-tim]]"
  - "[[event-kod-provincii]]"
...
| | Authentic Movement | Theatre of My Name |
|---|-------------------|-------------------|
| **Focus** | Mover (eyes closed, inner impulse) | **Witness** (request + neuromandala) |
| **Witness** | Non-judgmental observation | **Projects** request; interprets group dance |
...
Published comparisons on **Yandex Dzen** — see [[media-theatre-my-name-dzen|four-part series]]:

1. **Authentic Movement** (Mary Starks Whitehouse)  
2. **Family constellations** (Bert Hellinger) — projection and group field, without a directing facilitator in the dance itself  
...
| | Аутентичное движение | Театр Имени Меня |
|---|---------------------|------------------|
| **Фокус** | Движущийся (глаза закрыты, внутренний импульс) | **Свидетель** (запрос + нейромандала) |
| **Свидетель** | Наблюдение без оценки | **Проецирует** запрос; интерпретирует танец группы |
...
Опубликованные сравнения на **Яндекс Дзене** — [[media-theatre-my-name-dzen|серия из четырёх статей]]:

1. **Аутентичное движение** (Мэри Старкс Уайтхаус)  
2. **Системные расстановки** (Берт Хеллингер) — проекция и групповое поле, без фасилитатора в самом танце  
