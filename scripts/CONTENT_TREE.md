...
└── **home** (oda.dream)
    ...
    ├── **debug** (Debug)
    │   ├── **debug-action** (Action)
    │   ├── **debug-article** (Article) [📂 4]
    │   │     ├─ 🖼️ `https://commondatastorage.googleapis.com/gtv-vi...`
    │   │     ├─ 🖼️ `https://www.soundhelix.com/examples/mp3/SoundHe...`
    │   │     ├─ 🖼️ `https://images.unsplash.com/photo-1550684848-fa...`
    │   │     └─ 🖼️ `https://images.unsplash.com/photo-1550684848-fa...`
    │   ├── **debug-audio** (Audio) [📂 1]
    │   │     └─ 🖼️ `https://www.soundhelix.com/examples/mp3/SoundHe...`
    │   ├── **debug-hub** (Nested Hub)
    │   ├── **debug-image** (Image) [📂 2]
    │   │     ├─ 🖼️ `https://s662vla.storage.yandex.net/rdisk/fe9ae9...`
    │   │     └─ 🖼️ `/images/content/art-brain.jpg`
    │   └── **debug-video** (Video Page) [📂 6]
    │         ├─ 🖼️ `https://commondatastorage.googleapis.com/gtv-vi...`
    │         ├─ 🖼️ `url`
    │         ├─ 🖼️ `poster`
    ...
    │   │     ├─ 🖼️ `/images/content/lectures-veter.webp`
...
- **coaching** (Parent: workshops [Missing])
- **neuro-dance** (Parent: workshops [Missing])
- **gong** (Parent: workshops [Missing])
- **neurosync** (Parent: workshops [Missing])

## 📊 Media Manifest

| Node ID | Media Count | Files |
|---------|-------------|-------|
| for-events | 8 | `https://dzen.ru/embed/o20ZleGMJAAA?from_block=partner&from=zen&mute=0&autoplay=0&tv=0`<br/>`/images/content/neurobattle_dano.webp`<br/>`/images/content/mindshow_tpp.webp`<br/>`https://dzen.ru/embed/vZ6STYjxZhHk?from_block=partner&from=zen&mute=0&autoplay=0&tv=0`<br/>`/images/content/lectures-gonchar.webp`<br/>`neurobattle`<br/>`mindshow`<br/>`lectures` |
...
| debug-article | 4 | `https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4`<br/>`https://www.soundhelix.com/examples/mp3/SoundHelix-Song-1.mp3`<br/>`https://images.unsplash.com/photo-1550684848-fac1c5b4e853?q=80&w=800`<br/>`https://images.unsplash.com/photo-1550684848-fac1c5b4e853` |
| debug-audio | 1 | `https://www.soundhelix.com/examples/mp3/SoundHelix-Song-1.mp3` |
| debug-image | 2 | `https://s662vla.storage.yandex.net/rdisk/fe9ae9994e2ea46c208ae417f60fe1a835636227a37b894db0b26cdc78bf4c72/69814273/LkHz-i27zRjnrcgKR5Gf882_UfMdm5r76oTUUidK_annW5CNX3Qh4gz5bJMEer8RllUQf7QXSWwHcdIkC-0klA==?uid=94354112&filename=_Snap.1.png&disposition=inline&hash=&limit=0&content_type=image%2Fpng&owner_uid=94354112&fsize=822410&hid=37be66e7dc2673a57f9d862a51bd262f&media_type=image&tknv=v3&etag=0aeb47ad8f91ec0de16abf059d030cf7&ts=649e0982f42c0&s=8608769eebd6076c26a3d2b7805b2ffc7ebe1cb6abed691ee1d682967097f576&pb=U2FsdGVkX1_8CV3oMaPCg_AMl0BRVM__U_xBMfukWnpSQ68x4tYZ0Hscx4EFSV7Tc1wiBpXmoKA7aSWWOofe8TyNuJRpqXzkf94v75bBpVQ`<br/>`/images/content/art-brain.jpg` |
| debug-video | 6 | `https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4`<br/>`url`<br/>`poster`<br/>`https://dzen.ru/embed/o20aog1YJAAA?from_block=partner&from=zen&mute=1&autoplay=1&tv=0`<br/>`/images/content/neuromandala-cover.jpg`<br/>`обложка` |
| chastoti | 1 | `https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4` |
| events | 1 | `https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerBlazes.mp4` |
