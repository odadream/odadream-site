...
const downloadImage = (url, dest) => {
    return new Promise((resolve, reject) => {
        ...
        const fallback = () => {
            console.warn(`⚠️  Failed to download ${path.basename(dest)}. Generating fallback SVG.`);
...
// --- DATA ---
const nodes = [
    'home', 'neuromandala', 'works', 'events', 'collab', 'world', 'contacts',
    'games', 'neurobattle', 'brain-hack', 'journey',
    'lectures', 'art-brain', 'sound-brain', 'taste-brain', 'color-brain', 'empathy', 'neuroaesthetics-lec',
    'workshops', 'neuro-dance', 'neurosync', 'gong', 'coaching', 'mindshow',
    'research', 'heritage', 'schrodinger', 'sync-circle', 'dashran', 'posustoronniy',
    'objects', 'mom-baby', 'jewellery', 'emomandala',
    'chastoti', 'terraforming', 'portal', 'byob', 'pleinair',
    'for-events', 'for-business', 'for-galleries', 'for-artists',
    'manifesto', 'team', 'press', 'testimonials', 'acknowledgments'
];

const contentImages = [
    { name: 'neuromandala-cover.jpg', url: 'https://images.unsplash.com/photo-1550684848-fac1c5b4e853?q=80&w=1200' },
    { name: 'art-brain.jpg', url: 'https://images.unsplash.com/photo-1532153975070-2e9ab71f1b14?q=80&w=800' },
    { name: 'jewellery.jpg', url: 'https://images.unsplash.com/photo-1617038260897-41a1f14a8ca0?q=80&w=800' }
];
