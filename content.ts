...
// The text below drives the narrative of the application.

// --- ROOT ---
export const index_md = `## ODA.DREAM
...
// --- NEUROMANDALA ---
export const neuromandala_md = `## NEUROMANDALA
...
// --- WORKS ---
export const works_index_md = `## WORKS
...
// Works -> Games
export const games_neurobattle_md = `## NEUROBATTLE
...
export const games_brain_hack_md = `## BRAIN HACK
...
export const games_journey_md = `## JOURNEY TO YOURSELF
...
// Works -> Lectures
export const lectures_art_brain_md = `## ART OF THE BRAIN
...
export const world_testimonials_md = `## ECHOES
**What They Say**
...
export const world_acknowledgments_md = `## ACKNOWLEDGMENTS
**Gratitude**

To our patrons, our coders, and the scientists whose shoulders we stand on.`;

// --- CONTACTS ---
export const contacts_md = `## CONTACTS
**Signal**
